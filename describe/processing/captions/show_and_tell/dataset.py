...
def prepare_test_data(config, image_paths):
    """ Prepare the data for testing the model. """
    image_files = image_paths
    image_ids = list(range(len(image_files)))

    vocabulary = Vocabulary(5000,'\\describe\\processing\\captions\\show_and_tell\\vocabulary.csv')
    print("Vocabulary built.")
    print("Number of words = %d" %(5000))

    print("Building the dataset...")
    dataset = DataSet(image_ids, image_files, 32)
    print("Dataset built.")
